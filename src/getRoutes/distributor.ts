...
export default function setupDistributorRoutes(app: Express) {
  ...
  // =====================================================
  app.get("/api/salesApp/distributors", authenticateToken, async (req: AuthRequest, res: Response) => {
    try {
      const {
        search,
        limit = '50',
  ...
  // =====================================================
  app.get("/api/salesApp/distributors/:id", authenticateToken, async (req: AuthRequest, res: Response) => {
    try {
      const { id } = req.params;
